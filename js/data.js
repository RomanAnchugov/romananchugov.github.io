...
const JOBS = [
  ...
  {
    period: "2025 — сейчас", place: "WB.Тех", role: "Senior Mobile Developer",
    summary: "Разработка приложения Wibes — конкретно отвечаю за прямые трансляции, а также разработку SDK (библиотеки) для встраивания в WB.",
    stack: ["Kotlin", "Coroutines", "Room", "Retrofit"],
    screens: [
      { caption: "Прямые трансляции", from:"#2a2620", to:"#16130e" },
      { caption: "Wibes SDK", from:"#2e9e5b", to:"#123f25" }
    ]
  },
  {
